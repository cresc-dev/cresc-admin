...
// The real router pulls the layout and page tree into the test; stub it with
// the full path table so every nav entry resolves. Keep the table complete:
// bun's module mocks leak across files, so a partial stub elsewhere would
// otherwise break these cases.
mock.module('@/router', () => ({
  rootRouterPath: {
    home: '/',
    apps: '/apps',
