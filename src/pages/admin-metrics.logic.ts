...
/** Pure logic for the global metrics page: URL param parsing, totals and category splitting */
...
// Trust the server's _total when present, otherwise sum the bucket's categories
...
// Dict entries separate prefix and value with \u001f; an empty value shows as unknown rather than a bare prefix
...
// Distribution charts use a per-day percentage; count remains on each point
...
// A start after the end means the URL was hand-edited; fall back to "24 hours before the end" instead of taking it verbatim
