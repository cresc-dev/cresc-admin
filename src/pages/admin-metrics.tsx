...
export const Component = () => {
  ...
  // Global metrics carry no server total point; the share denominator is the per-bucket sum of categories
  ...
  // The total line is synthesized from the category sums and drawn alongside them
