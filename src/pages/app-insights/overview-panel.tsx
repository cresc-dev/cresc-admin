...
/** Refused native package versions with their request counts; requests from buckets that predate the split are called out separately. */
...
export const OverviewPanel = ({
  ...
  // Keep only the outcomes that actually appear in the window so the legend is
  // not padded with zeroes; colors stay pinned to the category either way.
