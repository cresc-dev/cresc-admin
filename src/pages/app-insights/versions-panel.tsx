...
/** Funnel bars: served → downloaded → activated → rolled back. */
...
export const VersionsPanel = ({
  ...
  // With a native package selected, served counts and events come from that
  // package's slice; the cumulative adopted / lag have no package dimension
  // and are kept as the version's own.
  const rows = useMemo(() => {
